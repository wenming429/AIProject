...
func (s *SessionManager) NewSession(uid string, conn IConn) {
...
func (s *SessionManager) GetConnIds(uid string) []int64 {
	return s.userSession.Get(uid)
}

func (s *SessionManager) GetSessions(uid string) []ISession {
