...
// Get 获取会话间的时序ID
func (s *Sequence) Get(ctx context.Context, seqType SequenceType, sourceId string) int64 {
	return s.snowflake.Generate().Int64()
}

// BatchGet 批量获取会话间的时序ID
func (s *Sequence) BatchGet(ctx context.Context, seqType SequenceType, sourceId string, num int) []int64 {
	ids := make([]int64, 0)
