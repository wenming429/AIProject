...
type Users struct {
	...
	tableCache core.TableCache[model.Users, string]
}

func NewUsers(db *gorm.DB, rds *redis.Client) *Users {
	return &Users{
		Repo:       core.NewRepo[model.Users](db),
		tableCache: core.NewTableCache[model.Users, string](rds),
	}
}
...
func (u *Users) FindByIdWithCache(ctx context.Context, id string) (*model.Users, error) {
	return u.tableCache.GetOrSet(ctx, id, func(ctx context.Context) (*model.Users, error) {
		return u.Repo.FindById(ctx, id)
	})
}

func (u *Users) ClearTableCache(ctx context.Context, id string) error {
