...
type ContactApply struct {
	Id        string    `gorm:"column:id;primaryKey" json:"id"` // 申请ID
	UserId    string    `gorm:"column:user_id;" json:"user_id"`                 // 申请人ID
	FriendId  string    `gorm:"column:friend_id;" json:"friend_id"`             // 被申请人
