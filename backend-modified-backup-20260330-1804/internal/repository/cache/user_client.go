...
func (u *UserClient) key(uid string) string {
	return fmt.Sprintf("im:user_clients:%s", uid)
}

func (u *UserClient) Bind(ctx context.Context, serverId string, clientId int64, uid string) error {
...
func (u *UserClient) UnBind(ctx context.Context, serverId string, clientId int64, uid string) error {
...
func (u *UserClient) GetClientList(ctx context.Context, uid string) ([]*Client, error) {
	items := make([]*Client, 0)
...
func (u *UserClient) IsOnline(ctx context.Context, uid string) bool {
