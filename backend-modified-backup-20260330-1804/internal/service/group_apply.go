...
type IGroupApplyService interface {
	Auth(ctx context.Context, applyId, userId string) bool
	Insert(ctx context.Context, groupId, userId string, remark string) error
	Delete(ctx context.Context, applyId, userId string) error
}
...
func (s *GroupApplyService) Auth(ctx context.Context, applyId, userId string) bool {
...
func (s *GroupApplyService) Insert(ctx context.Context, groupId, userId string, remark string) error {
...
func (s *GroupApplyService) Delete(ctx context.Context, applyId, userId string) error {
