...
type ITalkRecordService interface {
	...
	FindTalkPrivateRecord(ctx context.Context, uid string, msgId string) (*model.TalkMessageRecord, error)
	...
	FindForwardRecords(ctx context.Context, uid string, msgIds []string, talkType int) ([]*model.TalkMessageRecord, error)
}
...
func (s *TalkRecordService) FindTalkPrivateRecord(ctx context.Context, uid string, msgId string) (*model.TalkMessageRecord, error) {
...
func (s *TalkRecordService) FindForwardRecords(ctx context.Context, uid string, msgIds []string, talkType int) ([]*model.TalkMessageRecord, error) {
	var (
		fields = []string{
			"msg_id",
			"sequence",
...
func (s *TalkRecordService) handleTalkRecords(ctx context.Context, items []*model.TalkMessageRecord) ([]*model.TalkMessageRecord, error) {
	...
	hashUser := make(map[string]*model.Users)
