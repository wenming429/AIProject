...
type IContactService interface {
	UpdateRemark(ctx context.Context, uid string, friendId string, remark string) error
	Delete(ctx context.Context, uid, friendId string) error
	List(ctx context.Context, uid string) ([]*model.ContactListItem, error)
	GetContactIds(ctx context.Context, uid string) []string
	MoveGroup(ctx context.Context, uid string, friendId string, groupId string) error
}
...
func (s *ContactService) UpdateRemark(ctx context.Context, uid string, friendId string, remark string) error {
...
// @params uid      用户ID
// @params friendId 联系人ID
func (s *ContactService) Delete(ctx context.Context, uid, friendId string) error {
...
// List 获取联系人列表
// @params uid      用户ID
func (s *ContactService) List(ctx context.Context, uid string) ([]*model.ContactListItem, error) {
...
func (s *ContactService) GetContactIds(ctx context.Context, uid string) []string {
...
func (s *ContactService) MoveGroup(ctx context.Context, uid string, friendId string, groupId string) error {
