...
type IContactGroupService interface {
	Delete(ctx context.Context, id int, uid string) error
	GetUserGroup(ctx context.Context, uid string) ([]*model.ContactGroup, error)
}
...
func (c *ContactGroupService) Delete(ctx context.Context, id int, uid string) error {
...
func (c *ContactGroupService) GetUserGroup(ctx context.Context, uid string) ([]*model.ContactGroup, error) {
