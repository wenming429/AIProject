...
type IUserService interface {
	...
	UpdatePassword(ctx context.Context, uid string, oldPassword string, password string) error
	OauthBind(ctx context.Context, mobile string, oauthUser *model.OAuthUser) (string, error)
}
...
func (s *UserService) UpdatePassword(ctx context.Context, uid string, oldPassword string, password string) error {
...
func (s *UserService) OauthBind(ctx context.Context, mobile string, oauthUser *model.OAuthUser) (string, error) {
	...
	if userinfo != nil {
		...
		if oauth != nil && oauth.UserId == userinfo.Id {
			return userinfo.Id, nil
		}

		if oauth != nil {
			return "", entity.ErrAccountBinded
		}
