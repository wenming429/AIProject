...
type ITalkSessionService interface {
	List(ctx context.Context, uid string) ([]*model.SearchTalkSession, error)
	Create(ctx context.Context, opt *TalkSessionCreateOpt) (*model.TalkSession, error)
	Delete(ctx context.Context, uid string, talkMode int, toFromId string) error
	Top(ctx context.Context, opt *TalkSessionTopOpt) error
	Disturb(ctx context.Context, opt *TalkSessionDisturbOpt) error
	BatchAddList(ctx context.Context, uid string, values map[string]int)
}
...
func (s *TalkSessionService) List(ctx context.Context, uid string) ([]*model.SearchTalkSession, error) {
...
// Delete 删除会话
func (s *TalkSessionService) Delete(ctx context.Context, uid string, talkMode int, toFromId string) error {
...
func (s *TalkSessionService) BatchAddList(ctx context.Context, uid string, values map[string]int) {
