...
const file_web_v1_auth_proto_rawDesc = "" +
	"\n" +
	"\x11web/v1/auth.proto\x12\x03web\x1a\x1bbuf/validate/validate.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x1fgoogle/api/field_behavior.proto\"\x9e\x01\n" +
	"\x10AuthLoginRequest\x12'\n" +
	"\busername\x18\x01 \x01(\tB\v\xe2A\x01\x02\xbaH\x04r\x02\x10\x01R\busername\x12'\n" +
